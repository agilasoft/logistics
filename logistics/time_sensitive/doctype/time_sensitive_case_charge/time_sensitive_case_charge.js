...
frappe.ui.form.on("Time Sensitive Case Charge", {
	...
	service_type: function (frm, cdt, cdn) {
		if (window.logistics && logistics.linked_service_link_query) {
...
function _calculate_charge_row(frm, cdt, cdn, opts) {
	...
	frappe.call({
		...
		args: {
			doctype: "Time Sensitive Case Charge",
			parenttype: "Time Sensitive Case",
