...
# Re-sync the Air Freight Operations Dashboard Custom HTML Block from the
# logistics/fixtures/custom_html_block.json fixture so deployed sites pick up
# the new "Live Flights" tab without needing a manual re-import.
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Live Flights tab: synced {updated} Custom HTML Block document(s) from logistics/fixtures/custom_html_block.json.")
