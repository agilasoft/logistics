...
# Re-sync Air Freight Operations block: job status dropdown (no draft checkbox), no full-page/meta shipment line.
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (status filter / no meta).")
