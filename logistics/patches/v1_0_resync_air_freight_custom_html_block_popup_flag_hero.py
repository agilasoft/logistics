...
# Re-sync Air Freight Operations block: UNLOCO popup — flag above code (top-left), bold stat lines.
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (popup flag + UNLOCO stack).")
