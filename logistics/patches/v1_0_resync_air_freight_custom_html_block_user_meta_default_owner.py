...
# Re-sync Air Freight Operations block: meta shows User (session) not Company; default Owner = logged-in user.
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (user meta + default owner).")
