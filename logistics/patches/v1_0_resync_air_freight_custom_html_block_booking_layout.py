...
# Re-sync Air Freight Operations Custom HTML Block (Air Booking–style dashboard, session company, user filter).
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (Air Booking layout dashboard).")
