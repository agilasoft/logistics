...
"""Install Job Management operations dashboard Custom HTML Block and refresh the workspace."""
...
BLOCK_NAME = "Job Management Operations Dashboard"
WORKSPACE_NAME = "Job Management"
...
def _sync_workspace():
	...
	workspace_path = os.path.join(
		app_path, "job_management", "workspace", "job_management", "job_management.json"
	)
