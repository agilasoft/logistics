...
"""Install MICE operations dashboard Custom HTML Block and refresh the workspace."""
...
BLOCK_NAME = "MICE Operations Dashboard"
WORKSPACE_NAME = "MICE"
...
def _sync_workspace():
	...
	workspace_path = os.path.join(app_path, "mice", "workspace", "mice", "mice.json")
	...
	if frappe.db.exists("Workspace", WORKSPACE_NAME):
		...
		doc.module = data.get("module") or "MICE"
		doc.public = 1
