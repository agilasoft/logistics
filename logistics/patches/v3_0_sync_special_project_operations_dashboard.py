...
"""Install Special Projects operations dashboard Custom HTML Block and refresh the workspace."""
...
BLOCK_NAME = "Special Projects Operations Dashboard"
WORKSPACE_NAME = "Special Projects"
...
def _sync_workspace():
	...
	workspace_path = os.path.join(
		app_path, "special_projects", "workspace", "special_projects", "special_projects.json"
	)
	...
	if frappe.db.exists("Workspace", WORKSPACE_NAME):
		...
		doc.module = data.get("module") or "Special Projects"
		doc.public = 1
