...
# Re-sync Air Freight Operations block: Heat toolbar filters use same row layout as Owner (label left).
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (filter Owner row layout).")
