...
# Re-sync Air Freight Operations block: larger UNLOCO popup flag, top row aligned with map close.
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (popup flag top bar).")
