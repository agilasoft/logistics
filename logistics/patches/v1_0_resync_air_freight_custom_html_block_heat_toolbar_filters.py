...
# Re-sync Air Freight Operations block: Heat Map traffic + airline filters in toolbar; company-scoped API.
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (Heat Map toolbar filters).")
