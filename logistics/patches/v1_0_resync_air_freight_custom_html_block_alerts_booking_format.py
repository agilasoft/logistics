...
# Re-sync Air Freight Operations block: Alerts tab matches Air Booking (collapsible groups + doc count cards).
...
def execute():
	...
	if updated:
		frappe.db.commit()
		print(f"  Re-synced {updated} Custom HTML Block(s) (alerts booking format).")
