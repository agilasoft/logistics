...
"""SFCT Job Files Detail — drill-down for Open / Avg Age / Handled KPI cards."""
...
def get_columns():
	return [
		{"fieldname": "name", "label": _("Sea Shipment"), "fieldtype": "Link", "options": "Sea Shipment", "width": 150},
		...
		{"fieldname": "master_bill", "label": _("MBL"), "fieldtype": "Link", "options": "Master Bill", "width": 140},
		{"fieldname": "house_bl", "label": _("HBL"), "fieldtype": "Data", "width": 120},
	]
...
def get_data(filters):
	...
	rows = frappe.db.sql(
		"""
		SELECT
			name, job_status, booking_date, shipping_line, local_customer,
			origin_port, destination_port, direction, company, branch,
			cost_center, profit_center, master_bill, house_bl,
