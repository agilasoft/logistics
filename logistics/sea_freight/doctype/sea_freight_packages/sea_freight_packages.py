...
class SeaFreightPackages(Document):
	...
	def _get_parent_company(self):
		"""Get company from parent Sea Shipment."""
		if self.get("parenttype") == "Sea Shipment" and self.get("parent"):
			return frappe.db.get_value("Sea Shipment", self.parent, "company")
		return None
