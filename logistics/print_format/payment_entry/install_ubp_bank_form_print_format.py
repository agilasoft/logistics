"""Install / refresh Payment Entry Union Bank Telegraphic Transfer print format from repo HTML."""
...
def _html_path() -> str:
	...
	return os.path.join(app_root, "print_format", "payment_entry", "ubp_bank_form.html")
