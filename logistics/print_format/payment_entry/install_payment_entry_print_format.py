"""Install / refresh Payment Entry HTML print format from repo HTML."""
...
PRINT_FORMAT_NAME = "Payment Entry HTML"
DOC_TYPE = "Payment Entry"


def _html_path() -> str:
	app_root = os.path.dirname(frappe.get_app_path("logistics"))
	return os.path.join(app_root, "print_format", "payment_entry", "payment_entry.html")


def install_payment_entry_print_format() -> None:
