#!/usr/bin/env python3
"""
Install BIR Purchase Invoice Print Format
"""
import frappe
import os

def install_purchase_invoice_print_format():
    """Install or update the BIR Purchase Invoice print format"""
    ...
    if frappe.db.exists("Print Format", "BIR Purchase Invoice"):
        print_format = frappe.get_doc("Print Format", "BIR Purchase Invoice")
        print_format.html = html_content
        print_format.save()
        print("✓ Updated existing BIR Purchase Invoice print format")
    else:
        # Create new print format
        print_format = frappe.get_doc({
            "doctype": "Print Format",
            "name": "BIR Purchase Invoice",
        ...
        print("✓ Created new BIR Purchase Invoice print format")
