...
class OneOffQuoteTransport(Document):
	"""One-Off Quote Transport child table (same structure as Sales Quote Transport)."""
	...
	def validate(self):
		"""Validate the one-off quote transport record"""
...
def trigger_calculations_for_line(line_data):
	...
	try:
		...
		temp_doc = frappe.new_doc('One-Off Quote Transport')
