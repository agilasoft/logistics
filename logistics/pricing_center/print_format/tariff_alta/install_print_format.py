#!/usr/bin/env python3
"""Install Tariff ALTA print format."""
import os

import frappe

PRINT_FORMAT_NAME = "Tariff ALTA"
DOC_TYPE = "Tariff"
MODULE = "Pricing Center"


def install_tariff_alta_print_format():
	html_path = os.path.join(os.path.dirname(__file__), "tariff_alta.html")
	...
	frappe.db.commit()
	print(f"{PRINT_FORMAT_NAME} installed. Use Print > {PRINT_FORMAT_NAME} on Tariff.")
...
if __name__ == "__main__":
	...
	if site:
		...
		print(
			...
			"logistics.pricing_center.print_format.tariff_alta."
			"install_print_format.install_tariff_alta_print_format"
		)
