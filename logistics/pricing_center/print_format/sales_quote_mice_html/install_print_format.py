#!/usr/bin/env python3
"""Install Sales Quote MICE HTML print format."""
import os

import frappe

PRINT_FORMAT_NAME = "Sales Quote MICE HTML"
DOC_TYPE = "Sales Quote"
MODULE = "Pricing Center"


def install_sales_quote_mice_html_print_format():
	html_path = os.path.join(os.path.dirname(__file__), "sales_quote_mice_html.html")
...
if __name__ == "__main__":
	...
	if site:
		...
		frappe.connect()
		install_sales_quote_mice_html_print_format()
	else:
		print(
			"Usage: bench --site <site> execute "
			"logistics.pricing_center.print_format.sales_quote_mice_html."
			"install_print_format.install_sales_quote_mice_html_print_format"
		)
