#!/usr/bin/env python3
"""Install MICE Sales Quote HTML print format."""
import os

import frappe

PRINT_FORMAT_NAME = "MICE Sales Quote HTML"
DOC_TYPE = "Sales Quote"
MODULE = "Pricing Center"


def install_mice_sales_quote_html_print_format():
	html_path = os.path.join(os.path.dirname(__file__), "mice_sales_quote_html.html")
...
if __name__ == "__main__":
	...
	if site:
		...
		print(
			...
			"logistics.pricing_center.print_format.mice_sales_quote_html."
			"install_print_format.install_mice_sales_quote_html_print_format"
		)
