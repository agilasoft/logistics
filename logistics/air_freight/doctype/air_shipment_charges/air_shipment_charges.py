...
class AirShipmentCharges(Document):
    """Air Shipment Charges child table - uses centralized charge calculation."""

    def validate(self):
        validate_charge_item_not_manual_other_service(self, "Air Shipment Charges", "item_code")
    ...
    def calculate_charge_amount(self, parent_doc=None):
        """Recalculate charge amount. Called by Air Shipment recalculate_all_charges."""
