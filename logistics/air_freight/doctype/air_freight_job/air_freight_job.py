...
class AirFreightJob(Document):
	...
	def get_milestone_html(self):
		...
		"""
			...
			frappe.log_error(f"Error in get_milestone_html: {str(e)}", "Air Freight Job - Milestone HTML")
	...
	def get_port_coordinates(self, port_name):
		...
		try:
			...
			frappe.log_error(f"Error getting coordinates for {port_name}: {str(e)}", "Air Freight Job - Get Port Coordinates")
