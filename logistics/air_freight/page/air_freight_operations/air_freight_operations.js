// route: air-freight-operations
// title: Air Freight Operations

frappe.provide("logistics.air_freight_operations");
...
frappe.pages["air-freight-operations"].on_page_load = function (wrapper) {
  logistics.air_freight_operations.page = new logistics.air_freight_operations.AirFreightOperationsPage(wrapper);
};

(function () {
  class AirFreightOperationsPage {
    constructor(wrapper) {
      this.wrapper = $(wrapper);
      this.page = frappe.ui.make_app_page({
        parent: wrapper,
        title: __("Air Freight Operations"),
        single_column: true,
      });
      this.map = null;
        ...
        <div class="af-ops-dashboard">
          <div class="af-ops-toolbar form-inline">
            ...
            <span class="af-ops-filter-group af-ops-filter-group-airlines">
              <span class="af-ops-filter-lbl">${__("Airlines")}</span>
    ...
    _bind_airline_dropdown() {
      ...
      if (!logistics.air_freight_operations._afOpsAirlineDocClose) {
        logistics.air_freight_operations._afOpsAirlineDocClose = true;
        $(document).on("click.afOpsAirlineDd", (e) => {
    ...
    _render_alerts(summary, items) {
      ...
      items.forEach((it) => {
        ...
        const link = frappe.utils.get_form_link("Air Shipment", it.shipment);
        const row =
  ...
  logistics.air_freight_operations.AirFreightOperationsPage = AirFreightOperationsPage;
})();
