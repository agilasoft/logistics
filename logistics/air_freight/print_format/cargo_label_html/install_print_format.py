#!/usr/bin/env python3
"""Install or update the Cargo Label HTML print format for Air Shipment."""
import os

import frappe

PRINT_FORMAT_NAME = "Cargo Label HTML"
DOC_TYPE = "Air Shipment"
MODULE = "Air Freight"


def _html_path():
	return os.path.join(os.path.dirname(__file__), "cargo_label_html.html")


def install_cargo_label_html_print_format():
	...
	frappe.db.commit()
	print("Cargo Label HTML print format installed.")
...
if __name__ == "__main__":
	...
	if site:
		...
		print(
			"Usage: bench execute "
			"logistics.air_freight.print_format.cargo_label_html.install_print_format."
			"install_cargo_label_html_print_format"
		)
