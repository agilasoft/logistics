...
"""
Data mapping utilities for Lalamove integration

Maps data from various logistics modules to Lalamove API format
and vice versa.
"""
...
class LalamoveMapper:
    ...
    def _map_transport_order_to_quotation(self, docname: str) -> Dict[str, Any]:
        ...
        # Get first leg for pick/drop addresses
    ...
    def _map_transport_leg_to_quotation(self, docname: str) -> Dict[str, Any]:
        ...
        # Get contact from transport job if available
    ...
    def _map_warehouse_job_to_quotation(self, docname: str) -> Dict[str, Any]:
        ...
        # Determine service type from items
    ...
    def _map_air_shipment_to_quotation(self, docname: str) -> Dict[str, Any]:
        ...
        # Pick-up from airport/CFS (destination)
        # In practice, this would be the airport/CFS address at destination
    ...
    def _map_air_booking_to_quotation(self, docname: str) -> Dict[str, Any]:
        ...
        # Similar to Air Shipment but may have different fields
        doc = frappe.get_doc("Air Booking", docname)
        
        # Use similar logic to Air Shipment
        # This is a placeholder - implement based on Air Booking structure
        return self._map_air_shipment_to_quotation(docname)
    ...
    def _map_sea_shipment_to_quotation(self, docname: str) -> Dict[str, Any]:
        ...
        # For sea freight, usually use TRUCK service type
    ...
    def _map_sea_booking_to_quotation(self, docname: str) -> Dict[str, Any]:
        ...
        # Use similar logic to Sea Shipment
        # This is a placeholder - implement based on Sea Booking structure
        return self._map_sea_shipment_to_quotation(docname)
    
    # Helper methods
    
    def _create_stop_from_address(self, address_name: str) -> Dict[str, Any]:
        """Create Lalamove stop from Address doctype"""
        address = frappe.get_doc("Address", address_name)
        
        # Get coordinates (lat/lng) - this may need geocoding
    ...
    def _get_address_coordinates(self, address) -> Dict[str, float]:
        """Get coordinates from address (requires geocoding)"""
    ...
    def _map_packages_to_item(self, packages: List) -> Dict[str, Any]:
        ...
        # Get description from first package
        description = ""
    ...
    def _get_airport_address(self, airport_code: str) -> Optional[str]:
        """Get airport address (placeholder - implement based on airport data)"""
    ...
    def _get_port_address(self, port_code: str) -> Optional[str]:
        """Get port address (placeholder - implement based on port data)"""
